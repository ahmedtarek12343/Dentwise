...
function Hero() {
  return (
    <section className="relative flex items-center overflow-hidden pt-10 md:pt-0">
      {/* GRID BG  */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              ...
              {/* USER TESTIMONIALS */}
              <div className="pt-8">
                <div className="flex items-start md:items-center gap-6 md:flex-row flex-col">
                  {/* USER AVATARS */}
            ...
            <div className="relative lg:pl-8">
              ...
              <Image
                ...
                width={600}
                height={600}
                className="w-full h-auto bounce-hero md:block hidden"
              />
            </div>
          </div>
        </div>
